...
import org.aerogear.gsoc.kafkapoc.util.GenericGsonDeserializer;
...
public class GenericGsonDeserializerTest {
    ...
    @Before
    public void setup() {
        objectDeserializer = new GenericGsonDeserializer<>(Object.class);
        userDeserializer = new GenericGsonDeserializer<>(User.class);
    }
